...
class ViewBook extends Component{
  ...
  componentWillMount()
  {
    axios.get('http://18.222.233.12:3001/Books').then(
      (response)=>{
  ...
  addBook()
  {
    axios.post('http://18.222.233.12:3001/Books', this.state.addBookDetails).then((response)=>
    {
  ...
  deleteBook(id)
  {
    axios.delete('http://18.222.233.12:3001/Books/' +id).then((response)=>
    {
      this._refreshBooks();
    }).catch();
  }
  ...
  updateBook()
  {
    ...
    axios.put('http://18.222.233.12:3001/Books/' +this.state.editBookDetails.id,
    {
      title,
      author,
      isbn,
  ...
  _refreshBooks()
  {
    axios.get('http://18.222.233.12:3001/Books').then((response)=>
    {
      this.setState({
      Books:response.data
      })
