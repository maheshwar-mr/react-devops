...
class ViewBook extends Component{
  ...
  componentWillMount()
  {
    axios.get('http://52.14.213.120:3001/Books').then(
      (response)=>{
  ...
  addBook()
  {
    axios.post('http://52.14.213.120:3001/Books',this.state.addBookDetails).then((response)=>
    {
  ...
  deleteBook(id)
  {
    axios.delete('http://52.14.213.120:3001/Books/' +id).then((response)=>
    {
      this._refreshBooks();
    })
  }
  ...
  updateBook()
  {
    ...
    axios.put('http://52.14.213.120:3001/Books/' +this.state.editBookDetails.id,
    {
      title,
      author,
      isbn,
  ...
  _refreshBooks()
  {
    axios.get('http://52.14.213.120:3001/Books').then((response)=>
    {
      this.setState({
      Books:response.data
      })
